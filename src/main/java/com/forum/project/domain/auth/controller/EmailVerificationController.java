...
public class EmailVerificationController {
    ...
    public ResponseEntity<BaseResponseDto> requestEmailVerification(
        ...
        return BaseResponseDto.buildSuccessResponse("Verification email sent successfully.");
    }
    ...
    public ResponseEntity<BaseResponseDto> confirmEmailVerification(
        ...
        return BaseResponseDto.buildSuccessResponse("Email verified successfully.");
    }
}
