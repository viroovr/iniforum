...
class AuthControllerUnitTest {
    ...
    void testRequestLogin_Success() throws Exception {
        ...
        verify(cookieManager).createRefreshTokenCookie(refreshToken);
    }
    ...
    public void testLogout_Success() throws Exception {
        ...
        verify(cookieManager).getRefreshTokenFromCookies(any(HttpServletRequest.class));
    }
    ...
    public void testRefreshAccessToken_Success() throws Exception {
        ...
        when(cookieManager.getRefreshTokenFromCookies(any(HttpServletRequest.class))).thenReturn(refreshToken);
