...
import com.forum.project.infrastructure.persistence.key.CommentLikeKey;
import com.forum.project.infrastructure.persistence.queries.CommentLikeQueries;
...
class CommentLikeRepositoryJdbcImplTest {
    ...
    void insertAndReturnGeneratedKeys() {
        ...
        assertThat((Timestamp) result.get(CommentLikeKey.CREATED_DATE)).isAfter(expectedTimestamp);
    }
    ...
    @Test
    void findByUserIdAndCommentId_notExists() {
        Optional<CommentLike> result = commentLikeRepository.findByUserIdAndCommentId(1L, 1L);
